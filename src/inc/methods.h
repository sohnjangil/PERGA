...
kmertype *getKmerByBase(char *tmp_kmerseq, graphtype *graph);
kmertype *getKmer(uint64_t *kmerSeqInt, graphtype *graph);
kmertype *getKmerByHash(uint64_t hashvalue, uint64_t *kmerSeqInt, graphtype *graph);
